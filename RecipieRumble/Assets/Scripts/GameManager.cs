...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject fireworksPrefab; // A√±adir una referencia al prefab de fuegos artificiales
    public Canvas canvas; // A√±adir una referencia al Canvas

    private List<Card> cards = new List<Card>();
    public List<Recipe> recipes = new List<Recipe>();  // Hacer esta lista p√∫blica
...
private IEnumerator UpdateUserScoresCoroutine()
{
    ...
    float averageDishesPerEvent = 1;  // Implementa esta función según tu lógica
    ...
    string nivel = GetLevelNameFromIndex(currentLevel);  // Convertir el índice de nivel a su nombre correspondiente
    ...
    // Agregar el token de sesión a los encabezados de la solicitud
...
// Extensiones para la utilidad de JSON y la funci√≥n de mezclar listas (shuffle)
