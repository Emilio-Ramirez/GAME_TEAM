console.log('Executing populateDB.js');
...
async function populateDatabase() {
  try {
    ...
    // Eliminar todas las cartas y recetas existentes
    await Cartas.truncate();
    await Receta.truncate();

    // Reiniciar el autoincremento de la tabla "Cartas"
    await sequelize.query('ALTER TABLE Cartas AUTO_INCREMENT = 1');

    // Reiniciar el autoincremento de la tabla "Receta"
    await sequelize.query('ALTER TABLE Receta AUTO_INCREMENT = 1');
...
populateDatabase();
console.log('populateDB.js execution completed');
